...
const Hero = () => (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} animate-fade-right animate-once animate-duration-[3000ms] animate-ease-linear animate-normal `}>
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 ss:mb-[60px]`}>
            <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
                <img src={discount} alt="disc"
        ...
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            <img src={robot} alt="billing" className="w-[100%] h-[100%] relative z-[7] animate-bounce-slow"/>
